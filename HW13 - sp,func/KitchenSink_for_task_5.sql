...
/*
cost = 82% и сложный план выполнения
...
-- выходит что несмотря на соблазн написать isnull лучше писать ( or )
*/
...
/*По данному примеру отус - dynamic, на мой взгляд несмотря на много условий работает лучше чем dynamic, минусы сложный план запроса, плюсы прогнозируемая сложность выполнения.
В dynamic план и сложность запроса растет в зависимости от количества параметров, что несет в себе скрытое неизвестное 
Однако в нашем случае это простой пример и join двух таблиц с агрегацией по третьей, 
в зависимости от цели и структуры может быть и будет плюс, но я бы предпочла явный запрос
*/
